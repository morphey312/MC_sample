...
export default {
    ...
    computed: {
        externalIndex()  {
            return this.elasticSearchClient.getIndexName(CONSTANTS.ELASTICSEARCH.INDICES.REDIRECTS_EXTERNAL_V3);
        },
        internalIndex()  {
            return this.elasticSearchClient.getIndexName(CONSTANTS.ELASTICSEARCH.INDICES.REDIRECTS_INTERNAL_V3);
        },
    },
    mounted() {
        this.getStatuses();

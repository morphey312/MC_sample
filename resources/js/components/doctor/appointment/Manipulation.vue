            ...
            <model-form :model="model">
                <el-row :gutter="20">
                    <el-col :span="19">
                        <form-text
                            :autosize="true"
                            :placeholder="__('Проведенные манипуляции')"
                            :entity="model"
                            property="comment"
                        />
                    </el-col>
...
export default {
    ...
    data() {
        return {
            model: this.initManipulationRecord(),
    ...
    methods: {
        save() {
            ...
            this.model.save().then((response) => {
                ...
                this.model = this.initManipulationRecord();
            }).catch((e) => {
                this.$displayErrors(e);
            });
        },
        initManipulationRecord() {
            if (this.activeCard) {
                return new ManipulationRecord({

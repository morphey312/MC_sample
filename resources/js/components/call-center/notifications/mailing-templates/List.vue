...
<script>
import NotificationMailingTemplateRepository from "@/repositories/notification/mailing-template";

export default {
    data() {
        return {
            repository: new NotificationMailingTemplateRepository(),
            fields: [
                {
                    name: 'name',
                    sortField: 'name',
                ...
                },
                {
                    ...
                    width: '15%',
                    formatter: (value) => {
                        return this.$handbook.getOption('notification_mailing_scenario', value);
                    },
                },
                {
                    name: 'channel_name',

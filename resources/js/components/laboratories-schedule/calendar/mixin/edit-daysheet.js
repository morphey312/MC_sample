...
export default {
    ...
    methods: {
        ...
        deleteModelList() {
            let list = this.day_sheets.map(day => day.id);
        ...
        getSpecializationError(appointment) {
            ...
            return __('По специализации {specialization} есть запись на прием: {appointment}', {specialization: specialization.name, appointment: this.getAppointmentPeriod(appointment)});
        },
    },
}

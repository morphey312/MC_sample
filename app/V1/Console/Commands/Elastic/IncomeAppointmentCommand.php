...
use App\V1\Jobs\Elastic\Report\Income\BatchAppointmentJob;

class IncomeAppointmentCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'elastic-export:income_appointments {clinics*} {--date_from=} {--date_to=}';
     ...
     * @var string
     */
    protected $description = 'Send appointments data for income report to elastic';

...
use App\V1\Jobs\Elastic\Report\RedirectsV3\BatchAppointmentJob;

class RedirectsAppointmentCommandV3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'elastic-export:redirects_appointments_v3 {clinics*} {--date_from=} {--date_to=}';

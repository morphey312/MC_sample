...
class ServicePrices extends BaseMigrate
{
    /**
     * @var string
     */
    protected $srcTable = 'list_service_tarif';
    ...
    protected function prepareData($data)
    {
        ...
        $result['service_type'] = Service::RELATION_TYPE;
    ...
    {
        $clinicsIds = $this->getPivotData('list_service_tarif_clinic', 'id_tarif', $row->id_tarif, function($query) {
            return $query;
        })->map(function($clinic) {
    ...
    {
        $clinics = $this->getPivotData('list_service_tarif_clinic', 'id_tarif', $remoteId, function($query) {
            return $query;
        });

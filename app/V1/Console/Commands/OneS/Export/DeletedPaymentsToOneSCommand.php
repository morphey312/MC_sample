...
class DeletedPaymentsToOneSCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'export:deleted_payments_to_one_s {clinics*} {--date_from=} {--date_to=}';
     ...
     * @var string
     */
    protected $description = 'Export payments from clinics by single date with is_deleted=1';
